...
export const Task = ({ id, text, completed, list, onRemove, onEdit, onComplete }) => {
    const onChangeCheckbox = e => {
        onComplete(list.id, id, e.target.checked);
    }

    return <div key={id} className="tasks__items-row">
        <div className="checkbox">
            <input type="checkbox" onChange={onChangeCheckbox} name="" id={`task-${id}`} checked={completed} />
